...
(function (E, X) {
    ...
    function sb(a, b, c, d, e) {
        var f, g = a, c = p(c, 1);
        f = a / c;
        b || (b = [1, 2, 5, 10], d === !1 && (c === 1 ? b = [1, 2, 5, 10] : c <= 0.1 && (b = [1 / c])));
    ...
    ka.prototype = {
        defaultOptions: {
            ...
            labels: {enabled: !0, style: {color: "#fff", cursor: "default", fontSize: "11px"}, x: 0, y: 15},
            lineColor: "#C0D0E0",
            lineWidth: 1,
            minPadding: 0.01,
            maxPadding: 0.01,
            ...
            title: {align: "middle", style: {color: "#fff"}},
            type: "linear"
        },
        defaultYAxisOptions: {
            endOnTick: !0,
        ...
        init: function (a, b) {
            ...
            this.side =
                b.side || (this.horiz ? this.opposite ? 0 : 2 : this.opposite ? 0 : 3);
            this.setOptions(b);
    ...
    wa = pa(Q, {
        type: "column",
        pointAttrToOptions: {stroke: "borderColor", fill: "color", r: "borderRadius"}, //柱状图的颜色
        cropShoulder: 0,
        directTouch: !0,
